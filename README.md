...
Setup
  ...
  4) the outgoing URL in synology integration will be http://IP_ADDRESS:FLASK_PORT/SynologyLLM change IP_ADDRESS to what it is on your local PC your running the model on
